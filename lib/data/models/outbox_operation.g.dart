...
const OutboxOperationSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.string,
      enumMap: _OutboxOperationstatusEnumValueMap,
    ),
    r'type': PropertySchema(
      id: 6,
      name: r'type',
      type: IsarType.string,
      enumMap: _OutboxOperationtypeEnumValueMap,
    ),
  },
...
OutboxOperation _outboxOperationDeserialize(
  ...
  object.status =
      _OutboxOperationstatusValueEnumMap[reader.readStringOrNull(offsets[5])] ??
      OutboxStatus.pending;
  object.type =
      _OutboxOperationtypeValueEnumMap[reader.readStringOrNull(offsets[6])] ??
...
P _outboxOperationDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (_OutboxOperationstatusValueEnumMap[reader.readStringOrNull(
                offset,
              )] ??
              OutboxStatus.pending)
          as P;
    case 6:
      return (_OutboxOperationtypeValueEnumMap[reader.readStringOrNull(
                offset,
              )] ??
              OutboxOpType.downloadBook)
          as P;
...
const _OutboxOperationstatusEnumValueMap = {
  r'pending': r'pending',
  r'inFlight': r'inFlight',
  r'done': r'done',
  r'failed': r'failed',
};
const _OutboxOperationstatusValueEnumMap = {
  r'pending': OutboxStatus.pending,
  r'inFlight': OutboxStatus.inFlight,
...
extension OutboxOperationQueryWhereSort
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterWhere> anyCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension OutboxOperationQueryWhere
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterWhereClause>
  statusEqualTo(OutboxStatus status) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterWhereClause>
  statusNotEqualTo(OutboxStatus status) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(
...
extension OutboxOperationQueryFilter
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterFilterCondition>
  statusEqualTo(OutboxStatus value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'status',
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterFilterCondition>
  typeEqualTo(OutboxOpType value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'type',
...
extension OutboxOperationQuerySortBy
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterSortBy> sortByStatus() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
...
extension OutboxOperationQuerySortThenBy
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterSortBy> thenByStatus() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'status', Sort.asc);
    });
  }
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }
...
extension OutboxOperationQueryWhereDistinct
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QDistinct> distinctByStatus({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OutboxOperation, OutboxOperation, QDistinct> distinctByType({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension OutboxOperationQueryProperty
  ...
  QueryBuilder<OutboxOperation, int, QQueryOperations> attemptsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'attempts');
    });
  }

  QueryBuilder<OutboxOperation, DateTime?, QQueryOperations>
  completedAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OutboxOperation, String?, QQueryOperations> lastErrorProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OutboxOperation, OutboxStatus, QQueryOperations>
  statusProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<OutboxOperation, OutboxOpType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
